...
//	boolean sql_select_operation_continue;
	
	public FinanceRecorderStockBackupSQLTask(final LinkedList<Integer> source_type_index_list, final FinanceRecorderCompanyGroupSet company_group_set, FinanceRecorderCmnClass.QuerySet query_set, FinanceRecorderCmnClass.FinanceTimeRange finance_time_range, String finance_backup_root_folderpath, boolean operation_continue)
	{
		this(source_type_index_list, company_group_set, query_set, finance_time_range, finance_backup_root_folderpath, String.format("StockBackupSQLThread:%d", ++thread_count), operation_continue);
	}
	public FinanceRecorderStockBackupSQLTask(final LinkedList<Integer> source_type_index_list, final FinanceRecorderCompanyGroupSet company_group_set, FinanceRecorderCmnClass.QuerySet query_set, FinanceRecorderCmnClass.FinanceTimeRange finance_time_range, String finance_backup_root_folderpath, String description, boolean operation_continue)
	{
		...
		data_handler.enable_operation_continue(operation_continue);
		thread_description = description;
		csv_finance_time_range = finance_time_range;
		csv_query_set = query_set;
//		sql_select_operation_continue = operation_continue;
	}
