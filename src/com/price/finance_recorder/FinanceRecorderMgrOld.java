...
// Backup the data from MySQL
					...
					FinanceRecorderStockBackupSQLTask task = new FinanceRecorderStockBackupSQLTask(new FinanceRecorderMarketDataHandler(FinanceRecorderCmnDef.FinanceSourceType.valueOf(finance_source_type_index)), time_range_slice_cfg, csv_backup_foldername, finance_backup_source_field_table.get(finance_source_type_index));
					Future<Integer> res = executor.submit(task);
					res_list.add(res);
				}
			}
