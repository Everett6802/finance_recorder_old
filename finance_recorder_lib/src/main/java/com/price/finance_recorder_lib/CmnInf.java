...
//		For transforming data from SQL into CSV, I assumed the time range of each SQL data source should be identical
		short read_from_sql(CmnClass.QuerySet query_set, CmnClass.FinanceTimeRange finance_time_range, CmnClass.ResultSetMap result_set_map);
...
//		String get_finance_restore_foldername();
		...
		short initialize();
		void set_delete_sql_accuracy(CmnDef.DeleteSQLAccurancyType accurancy_type); // Only work in stock mode
