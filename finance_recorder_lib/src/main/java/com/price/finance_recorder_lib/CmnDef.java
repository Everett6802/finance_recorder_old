...
public class CmnDef extends FinanceRecorderCmnDef
{
	...
	// public static final short RET_FAILURE_WARN_INDEX_DUPLICATE =
	// RET_FAILURE_WARN_BASE + 1;
	// public static final short RET_FAILURE_WARN_INDEX_IGNORE =
	// RET_FAILURE_WARN_BASE + 2;
	// public static final short RET_FAILURE_WARN_PROCESS_CONTINUE =
	// RET_FAILURE_WARN_BASE + 3;
	//
	// public static final short RET_FAILURE_BASE = 0x100;
	// public static final short RET_FAILURE_UNKNOWN = RET_FAILURE_BASE + 1;
	// public static final short RET_FAILURE_INVALID_ARGUMENT = RET_FAILURE_BASE
	// + 2;
	// public static final short RET_FAILURE_INVALID_POINTER = RET_FAILURE_BASE
	// + 3;
	// public static final short RET_FAILURE_INSUFFICIENT_MEMORY =
	// RET_FAILURE_BASE + 4;
	// public static final short RET_FAILURE_INCORRECT_OPERATION =
	// RET_FAILURE_BASE + 5;
	// public static final short RET_FAILURE_NOT_FOUND = RET_FAILURE_BASE + 6;
	// public static final short RET_FAILURE_INCORRECT_CONFIG = RET_FAILURE_BASE
	// + 7;
	// public static final short RET_FAILURE_HANDLE_THREAD = RET_FAILURE_BASE +
	// 8;
	// public static final short RET_FAILURE_INCORRECT_PATH = RET_FAILURE_BASE +
	// 9;
	// public static final short RET_FAILURE_IO_OPERATION = RET_FAILURE_BASE +
	// 10;
	// public static final short RET_FAILURE_UNEXPECTED_VALUE = RET_FAILURE_BASE
	// + 11;
	//
	...
	// public static final short RET_FAILURE_MYSQL_UNKNOWN_DATABASE =
	// RET_FAILURE_MYSQL_BASE + 2;
	// public static final short RET_FAILURE_MYSQL_NO_DRIVER =
	// RET_FAILURE_MYSQL_BASE + 3;
	// public static final short RET_FAILURE_MYSQL_EXECUTE_COMMAND =
	// RET_FAILURE_MYSQL_BASE + 4;
	// public static final short RET_FAILURE_MYSQL_DATABASE_ALREADY_EXIST =
	// RET_FAILURE_MYSQL_BASE + 5;
	// public static final short RET_FAILURE_MYSQL_DATA_NOT_CONSISTENT =
	// RET_FAILURE_MYSQL_BASE + 6;
	//
	// public static boolean CheckSuccess(short x) {return (x == RET_SUCCESS ?
	// true : false);}
	//
	// public static boolean CheckFailure(short x) {return !CheckSuccess(x);}
	//
	// public static boolean CheckFailureWarnProcessContinue(short x) {return (x
	// == RET_FAILURE_WARN_PROCESS_CONTINUE ? true : false);}
	// public static boolean CheckFailureNotFound(short x) {return (x ==
	// RET_FAILURE_NOT_FOUND ? true : false);}
	//
	// public static boolean CheckMySQLFailureUnknownDatabase(short x) {return
	// (x == RET_FAILURE_MYSQL_UNKNOWN_DATABASE ? true : false);}
	
	////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Constants
	static FinanceAnalysisMode FINANCE_MODE = null; // Will be determined after
													// argument setting in main
	static boolean IS_FINANCE_MARKET_MODE;// = is_market_mode(); // Will be
											// determined after argument setting
											// in main
	static boolean IS_FINANCE_STOCK_MODE;// = !IS_FINANCE_MARKET_MODE; // Will
											// be determined after argument
											// setting in main
	...
	static final String FINANCE_SCRAPY_PROJECT_NAME = "finance_scrapy";
	static final String FINANCE_SCRAPY_SCRIPT_NAME = "finance_scrapy.py";
	static final String FINANCE_SCRAPY_CMD_FORCE_SWITCH_FINANCE_MODE_ARGUMENT = "--force_switch_finance_mode";
	static final String FINANCE_SCRAPY_CMD_METHOD_ARGUMENT = "--method";
	static final String FINANCE_SCRAPY_CMD_TIME_DURATION_RANGE_ARGUMENT = "--time_duration_range";
	static final String FINANCE_SCRAPY_CMD_COMPANY_ARGUMENT = "--company";
	static final String FINANCE_RECORDER_PROJECT_NAME = "finance_recorder";
	static final String FINANCE_ANALYZER_PROJECT_NAME = "finance_analyzer";
	static final String FINANCE_SCRAPY_ROOT_FOLDERPATH = String.format("%s/%s", DEFAULT_FINANCE_ROOT_FOLDERPATH,
			FINANCE_SCRAPY_PROJECT_NAME);
	static final String FINANCE_RECORDER_ROOT_FOLDERPATH = String.format("%s/%s", DEFAULT_FINANCE_ROOT_FOLDERPATH,
			FINANCE_RECORDER_PROJECT_NAME);
	static final String FINANCE_ANALYZER_ROOT_FOLDERPATH = String.format("%s/%s", DEFAULT_FINANCE_ROOT_FOLDERPATH,
			FINANCE_ANALYZER_PROJECT_NAME);
	static final String DEFAULT_COMPANY_PROFILE_CONF_FOLDERPATH = String.format("%s/%s", FINANCE_SCRAPY_ROOT_FOLDERPATH,
			CONF_FOLDERNAME);
	static final String DEFAULT_STATEMENT_PROFILE_CONF_FOLDERPATH = String.format("%s/%s",
			FINANCE_SCRAPY_ROOT_FOLDERPATH, CONF_FOLDERNAME);
	static final String CONFIG_TIMESTAMP_STRING_PREFIX = "#time@";
	// static final String CSV_FOLDERPATH = String.format("%s/%s",
	// CSV_ROOT_FOLDERPATH, (IS_FINANCE_MARKET_MODE ? CSV_MARKET_FOLDERNAME :
	...
	static final String[] STATEMENT_FIELD_NAME_CONF_FILENAME_ARRAY = new String[]
	{ BALANCE_SHEET_FIELD_NAME_CONF_FILENAME, INCOME_STATEMENT_FIELD_NAME_CONF_FILENAME,
			CASH_FLOW_STATEMENT_FIELD_NAME_CONF_FILENAME, STATEMENT_OF_CHANGES_IN_EQUITY_FIELD_NAME_CONF_FILENAME };
	...
	static final String[] FINANCE_TIME_REGEX_STRING_FORMAT_ARRAY = new String[]
	{ FINANCE_DATE_REGEX_STRING_FORMAT, FINANCE_MONTH_REGEX_STRING_FORMAT, FINANCE_QUARTER_REGEX_STRING_FORMAT };
	
	static final String CSV_FILE_ROOT_FOLDERPATH = "/var/tmp/finance";
	// static final String MARKET_CSV_FILE_ROOT_FOLDERPATH =
	// String.format("%s/market", CSV_FILE_ROOT_FOLDERPATH);
	// static final String STOCK_CSV_FILE_ROOT_FOLDERPATH =
	// String.format("%s/stock", CSV_FILE_ROOT_FOLDERPATH);
	...
	static enum FinanceMethod
	{
		...
		// //////////////////////////////////////////////////////////////////////////////////////////////
		// Market data source
		FinanceMethod_MarketStart(0), // Keep in mind to update the value at the
										// right time
		FinanceMethod_StockExchangeAndVolume(0), FinanceMethod_StockTop3LegalPersonsNetBuyOrSell(
				1), FinanceMethod_StockMarginTradingAndShortSelling(
						2), FinanceMethod_FutureAndOptionTop3LegalPersonsOpenInterest(
								3), FinanceMethod_FutureOrOptionTop3LegalPersonsOpenInterest(
										4), FinanceMethod_OptionTop3LegalPersonsBuyAndSellOptionOpenInterest(
												5), FinanceMethod_OptionPutCallRatio(
														6), FinanceMethod_FutureTop10DealersAndLegalPersons(
																7), FinanceMethod_MarketEnd(8), // Keep
																								// in
																								// mind
																								// to
																								// update
		...
		// //////////////////////////////////////////////////////////////////////////////////////////////
		// Stock data source
		FinanceMethod_StockStart(8), // Keep in mind to update the value at the
										// right time
		FinanceMethod_DepositoryShareholderDistributionTable(8), FinanceMethod_StockStatementStart(9), // Keep
																										// in
																										// mind
																										// to
																										// update
																										...
																										// right
																										// time
		FinanceMethod_BalanceSheet(9), FinanceMethod_IncomeStatement(10), FinanceMethod_CashFlowStatement(
				11), FinanceMethod_StatementOfChangesInEquity(12), FinanceMethod_StockStatementEnd(13), // Keep
																										// in
																										// mind
																										// to
																										// update
																										...
																										// right
																										// time
		FinanceMethod_DailyStockPriceAndVolume(13), FinanceMethod_Top3LegalPersonsStockNetBuyOrSellSummary(
				14), FinanceMethod_StockEnd(15); // Keep in mind to update the
		...
		//// Stock End
		// default:
		// throw new IllegalArgumentException(String.format("Unknown Finance
		// Source Type: %d", value));
		// }
		// }
		...
		{
			return ((method_index >= FinanceMethod_MarketStart.value)
					&& (method_index < FinanceMethod_MarketEnd.value));
		}
	...
	{
		FinanceField_INT(0), FinanceField_LONG(1), FinanceField_FLOAT(2), FinanceField_DATE(3);
	...
	{
		FinanceTime_Date(0), FinanceTime_Month(1), FinanceTime_Quarter(2), FinanceTime_Undefined(3);
	...
	{
		FinanceTimeRange_Between(0), FinanceTimeRange_Greater(1), FinanceTimeRange_GreaterEqual(
				2), FinanceTimeRange_Less(3), FinanceTimeRange_LessEqual(4), FinanceTimeRange_Undefined(5);
	...
	{
		Operation_NonStop, Operation_Stop,
	};
	
	static enum DatabaseEnableBatchType
	{
		DatabaseEnableBatch_Yes, DatabaseEnableBatch_No,
	};
	
	static enum CreateThreadType
	{
		CreateThread_Single, CreateThread_Multiple,
	};
	
	static enum ResultSetDataUnit
	{
		ResultSetDataUnit_NoMethod, ResultSetDataUnit_Method
	};
	
	static enum CSVWorkingFolderType
	{
		CSVWorkingFolder_Write(0), CSVWorkingFolder_Backup(1), CSVWorkingFolder_Restore(2), CSVWorkingFolder_Unknown(3);
	...
	{
		CSVSourceLocation_Local(0), CSVSourceLocation_Remote(1), CSVSourceLocation_Unknown(3);
	...
	{
			// Market Start
			"stock_exchange_and_volume", "stock_top3_legal_persons_net_buy_or_sell",
			"stock_margin_trading_and_short_selling", "future_and_option_top3_legal_persons_open_interest",
			"future_or_option_top3_legal_persons_open_interest",
			"option_top3_legal_persons_buy_and_sell_option_open_interest", "option_put_call_ratio",
			"future_top10_dealers_and_legal_persons",
			// Market End
			///////////////////////////////////////////////////////////
			// Stock Start
			"company_depository_shareholder_distribution_table", "balance_sheet", "income_statement",
			"cash_flow_statement", "statement_of_changes_in_equity", "daily_stock_price_and_volume",
	...
	{
			// Market Start
			"臺股指數及成交量", "三大法人現貨買賣超", "現貨融資融券餘額", "三大法人期貨和選擇權留倉淨額", "三大法人期貨或選擇權留倉淨額", "三大法人選擇權買賣權留倉淨額", "三大法人選擇權賣權買權比",
			"十大交易人及特定法人期貨資訊",
			// Market End
			///////////////////////////////////////////////////////////
			// Stock Start
			"個股集保戶股權分散表", "資產負債表", "損益表", "現金流量表", "股東權益變動表", "個股日股價及成交量", "三大法人個股買賣超日報",
			// Stock End
	};
	static final String[] FINANCE_DATA_FOLDER_MAPPING = new String[]
	{ "market", "market", "market", "market", "market", "market", "market", "market", "stock", "stock", "stock",
			"stock", "stock", "stock", "stock", };
	static final String[] FINANCE_DATA_SQL_FIELD_LIST = new String[]
	{
			// Market Start
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefMarketDB.STOCK_EXCHANGE_AND_VALUE_FIELD_DEFINITION,
							CmnDefMarketDB.STOCK_EXCHANGE_AND_VALUE_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefMarketDB.STOCK_TOP3_LEGAL_PERSONS_NET_BUY_OR_SELL_FIELD_DEFINITION,
							CmnDefMarketDB.STOCK_TOP3_LEGAL_PERSONS_NET_BUY_OR_SELL_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefMarketDB.STOCK_MARGIN_TRADING_AND_SHORT_SELLING_FIELD_DEFINITION,
			...
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefMarketDB.OPTION_PUT_CALL_RATIO_FIELD_DEFINITION,
							CmnDefMarketDB.OPTION_PUT_CALL_RATIO_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefMarketDB.FUTURE_TOP10_DEALERS_AND_LEGAL_PERSONS_FIELD_DEFINITION,
			...
			transform_array_to_sql_string(merge_string_array_element(CmnDefStockDB.BALANCE_SHEET_TABLE_FIELD_DEFINITION,
					CmnDefStockDB.BALANCE_SHEET_TABLE_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefStockDB.INCOME_STATEMENT_TABLE_FIELD_DEFINITION,
							CmnDefStockDB.INCOME_STATEMENT_TABLE_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefStockDB.CASH_FLOW_STATEMENT_TABLE_FIELD_DEFINITION,
							CmnDefStockDB.CASH_FLOW_STATEMENT_TABLE_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefStockDB.STATEMENT_OF_CHANGES_IN_EQUITY_TABLE_FIELD_DEFINITION,
							CmnDefStockDB.STATEMENT_OF_CHANGES_IN_EQUITY_TABLE_FIELD_TYPE_DEFINITION)),
			transform_array_to_sql_string(
					merge_string_array_element(CmnDefStockDB.DAILY_STOCK_PRICE_AND_VOLUME_TABLE_FIELD_DEFINITION,
	...
	static final String[][] FINANCE_DATA_SQL_FIELD_DEFINITION_LIST = new String[][]
	{
			...
			// Stock Start
			CmnDefStockDB.COMPANY_DEPOSITORY_SHAREHOLDER_DISTRIBUTION_TABLE_FIELD_DEFINITION,
			CmnDefStockDB.BALANCE_SHEET_TABLE_FIELD_DEFINITION, CmnDefStockDB.INCOME_STATEMENT_TABLE_FIELD_DEFINITION,
	...
	private static String[] merge_string_array_element(String[] string_arr1, String[] string_arr2)
	{
		...
		{
			assert false : String.format("The length of string_arr1 and string_arr2 are NOT equal: %d, %d",
